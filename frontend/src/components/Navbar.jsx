...
//           <Link to="/product/:id" className="hover:text-gray-300 transition">Shop</Link>
    ...
    <nav className="fixed top-0 left-0 w-full z-50">
      ...
      <div className="bg-black text-white flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex space-x-8 font-medium">
          <Link to="/" className="hover:text-gray-300 transition">Home</Link>
          <Link to="/about" className="hover:text-gray-300 transition">About</Link>
          {/* ⬇️ ICI : lien Shop vers l'id fixe */}
          <Link to="/product/68a855a3d6068d80488bfb8d" className="hover:text-gray-300 transition">Shop</Link>
          <Link to="/contact" className="hover:text-gray-300 transition">Contact</Link>
        </div>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* ⬇️ ICI : lien Shop mobile vers l'id fixe */}
          <Link
            to="/product/68a855a3d6068d80488bfb8d"
            onClick={() => setIsOpen(false)}
            className="block text-lg hover:text-gray-300 transition"
          >
            Shop
