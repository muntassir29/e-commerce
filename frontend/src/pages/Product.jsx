        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Découvrez en vidéo comment <strong>WALLET TRACKER</strong> peut vous
              aider à localiser vos objets en toute simplicité grâce à la
              technologie Apple <em>"Localiser"</em>.
            </p>
