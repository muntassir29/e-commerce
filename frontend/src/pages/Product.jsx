  ...
  const faqData = [
    {
      ...
      answer:
        "Trazcard utilise la technologie Bluetooth et se connecte à l’application Apple 'Localiser'. Vous pouvez suivre votre portefeuille ou vos objets à tout moment depuis votre iPhone, sans installer d’application supplémentaire.",
    },
    {
      question: "Est-ce compatible avec Android ?",
      answer:
        "Non. Trazcard est uniquement compatible avec les appareils Apple (iPhone, iPad, Mac) utilisant iOS 14.5 ou supérieur. L’intégration se fait directement avec l’app 'Localiser', sans application tierce.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Ajouter votre TrazCard à votre iPhone est simple et rapide. Il suffit d’ouvrir l’application 'Localiser', de cliquer sur 'Ajouter un objet', puis de rapprocher la carte de votre iPhone. Elle sera détectée automatiquement et prête à l'emploi.",
    },
  ];
      ...
      >
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">
            🎥 Découvrez Trazcard en action
          </h2>
          <p className="text-gray-600 leading-relaxed">
            Découvrez en vidéo comment <strong>Trazcard</strong> peut vous aider
